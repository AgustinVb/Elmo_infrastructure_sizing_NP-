...
1) Para carpetas desacopladas (_Desc_*): corre combine_macrobloques_for_plot.py
...
Omite subcarpetas _stage1 y station_X_dY individuales.
"""
...
def main():
    ...
    for d in descomp:
        ...
        if not combined.exists():
            print(f"  ⚠️  {d.name}/combined no existe")
            continue
        ...
        if day_dirs:
            ...
            print(f"  ⚠️  {d.name}/combined sin estructura reconocible")
