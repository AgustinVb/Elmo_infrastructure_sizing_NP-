...
battery-swapping 160kW del caso de estudio MCHS.

Correr con la rama battery_swapping_multiano checked out.
...
En battery-swapping b_bar/R se modelan UNA vez para todo el pool (no por
LHD ni por estacion), asi que la trayectoria es una sola serie por año.
"""
import json
from pathlib import Path

REPO_ROOT = Path(__file__).resolve().parent.parent
ROOT = REPO_ROOT / "output" / "DCH_160kW_2dias_wp2"
SCENARIO = "battery_swapping_160kW"
OUT_NAME = "dch_bs_160kW_degradation.json"

# Fraccion de b_max que recupera un reemplazo (b_y_link). En la rama de swap
# esta hardcodeada en 0.3 igual que en on-board, no viaja en parameters.json.
...
def main():
    ...
    b_max = float(params.get("b_max_pool", params.get("b_max_fleet", 0.0)))
