...
# -*- coding: utf-8 -*-
"""
Extrae la potencia peak (max P_red[y,d,t]) por año, escenario carga
on-board 960kW. Correr con la rama carga_ob_multiano checked out.
"""
import json
...
def main():
    ...
    out_path = Path(__file__).resolve().parent / "ob_960kW_peak_power.json"
