...
\begin{itemize}
    ...
    \item $G_{g,y}\geq0$, $\Delta G_{g,y}\geq0$: capacidad acumulada e instalada del generador $g$ al año $y$.
    \item $H_{y}\in\mathbb{Z}_{\geq0}$, $\Delta H_{y}\in\mathbb{Z}_{\geq0}$: unidades acumuladas e instaladas del cluster de almacenamiento al año $y$ (sin índice $h$, un único cluster candidato, igual que en \texttt{carga\_ob\_multiaño}).
\end{itemize}
