...
class OptRules(object):
    ...
    def __init__(self, mine_system, time_series, daily_target_override=None, autonomous_mode=False, pause_scheme='det', charge_window='restringida'):
        ...
        # permite cargar o estar detenido. True = modo autonomo, la colacion
        # ademas permite operar (viajar/extraer). El cambio de turno
...
class OptSets(OptRules):
    ...
    def build_sets(self, model):
        ...
        # solo puede cargar o estar detenido durante esta ventana.
