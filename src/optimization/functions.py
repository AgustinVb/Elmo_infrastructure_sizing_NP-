...
class OptParameters(OptRules):
    ...
    def build_parameters(self, model):
        ...
        # Eficiencia de carga/descarga de la baterÃ­a (hoja LHD)
...
class ConstraintRules(OptRules):
    ...
    def battery_soc_swap(self, model, i, d, t):
        ...
        if t >= t0:
            return model.B[i, d, t] ==  model.B_s[i, d, t-1] - discharge_eff
    ...
    def max_installed_capacity_swap(self, model, k, d, t):
        ...
        return sum(model.Sv[k, d, t, a] for a in model.time_intervals_set) <= model.n_max_k[k]
    ...
    def peak_power_swap(self, model, d, t):
        ...
        return sum(model.Sv[k, d, t, a] for k in model.stations_set for a in model.time_intervals_set) <= model.n_peak_max
