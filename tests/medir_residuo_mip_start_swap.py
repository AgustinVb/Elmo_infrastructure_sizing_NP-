...
una restriccion sin identificar; en swap a 6 anios el hibrido lo rechazo
por 4,9e-5 (x937763). A 2 anios el mayor residuo era 1,05e-9. Esto
...
Uso:  python tests/medir_residuo_mip_start_swap.py [escenario] [anios]
"""
import os
import sys
import tempfile
