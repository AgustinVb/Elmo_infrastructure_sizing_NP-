...
Uso:  python tests/test_presolve_capacidad_ob.py [escenario] [anios]
...
from test_gate_cortes_ob import _cache_path, estado_desde_monolitico
...
def n_ssee_de_una_solucion_factible(mine_system, time_series, exo_by_year, links, cache):
    ...
    x = estado_desde_monolitico(mono, links, y1)
    return x["n_ssee_k"], f"incumbente monolitico ({res.solver.termination_condition})"
